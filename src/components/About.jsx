  ...
  return (
    ...
    <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
        ...
        <div className="flex-1">
            <p className="mb-10 max-w-2xl font-Ovo">I'm Priyanka, a dedicated Computer Science and Engineering student at BIEW, set to graduate in 2025. My passion lies in web development, particularly in AI and cloud technologies. Currently, I'm gaining hands-on experience through internships, focusing on predictive analytics and full-stack development. I enjoy creating innovative solutions and am eager to expand my skills in technologies like Django and Node.js. I'm also committed to continuous learning and personal growth, which I actively pursue through various projects and competitions.</p>
            ...
            <ul className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2xl">
                ...
                ">
                    ...
                    <p className="text-gray-600 text-sm dark:text-white/80">HTML, CSS, JavaScript React Js, Python </p>
                </li>
